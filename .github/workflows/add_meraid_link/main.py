...
def main():
    header, mermeid, footer = split_file_lines(name.target_file_path)

    new_lines = update_markdown_lines(header, mermeid, footer)
...
def update_markdown_lines(header, mermeid, footer):
